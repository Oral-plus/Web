...
<div class="form-container">
    <img src="https://oral-plus.com/imginicio/logosas.png" alt="Logo Oral-Plus" class="logo">
    
    <h2>Estado de Cartera</h2>
    
    <label for="CardCode">Ingrese su código:</label>
    <input type="text" name="CardCode" id="CardCode" required class="input-field" >
    ...
    <a href="https://wa.me/send?text=Hola, este es el comprobante de pago&phone=573218290212"> 
        <button class="btn-secondary"> Enviar Comprobante</button>
    </a> 
</div>
</center>
<br>
<img class="fondo2" src="imginicio/Beneficios.jpg" alt="Descripci�n de la imagen" >
<br>
   <style>
...
.form-container {
    ...
    text-align: center;
    width: 360px;
    animation: caerSuavemente 0.8s ease-out;
...
.form-container input[type="button"] {
    ...
    border: none;
    border-radius: 6px;
    background: linear-gradient(to right, #004C97, #0073E6);
    color: white;
    font-size: 16px;
    font-weight: 600;
    cursor: pointer;
